        ...
        $.ajax({
            ...
            success: function(d) {
                ...
                for (var i=0; i < 10; i++){
                    ...
                    $this_product.find('.name').html(d.result[i].product);
                    $this_product.addClass('show');
                }
                for (var i=10; i < 20; i++){
                    var $this_product = $('.col-2 .product:nth-child('+(i-4)+')');
                    $this_product.find('.name').html(d.result[i].product);
                    $this_product.addClass('show');
                }
                Prism.highlightAll();
