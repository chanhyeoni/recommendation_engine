...
var recommendation = {
    ...
    products: function(){
        for (var i=0; i < 5; i++){
            $('.col-1').append('<li class="product" data-id="'+i+'">'+beer_svg+'<span class="name"></span></li>');
        }
        for (var i=5; i < 10; i++){
            $('.col-2').append('<li class="product" data-id="'+i+'">'+beer_svg+'<span class="name"></span></li>');
        }
    },
    submit: function(){
